...
twitch_miner.mine(
    [
      ...
      Streamer("ruletarbx", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)),
      Streamer("mike_belli", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)),
