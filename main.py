...
twitch_miner.mine(
    [
      ...
      Streamer("SpeedyShark_YT", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)), # 24 de mayo
      Streamer("mafxkey", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)),
      Streamer("mikusz_play", settings=StreamerSettings(follow_raid=True , claim_drops=True  , watch_streak=True)),
